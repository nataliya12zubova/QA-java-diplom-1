...
public class BurgerTest {
    ...
    public void createBurger(){
        ...
        Mockito.when(ingredientFilling.getName()).thenReturn("Говяжья котлета");
        ...
        Mockito.when(ingredientSauce.getName()).thenReturn("Барбекю");
    ...
    public void shouldGetValidReceipt() {
        ...
        String expectedReceipt = "(==== Пшеничная ====)" + "\r\n"+ "= sauce Барбекю ="+"\r\n"+
